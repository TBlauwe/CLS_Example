...
macro(download_library)
	...
	if(NOT ${${name}_ADDED})
		...
		list(APPEND CLS_EXAMPLE_MISSING_DEPENDENCIES "${DOWNLOAD_LIBRARY_NAME}[${_VERSION}]")
	else()
...
macro(find_library _NAME)
	...
	if(NOT ${${_NAME}_FOUND})
		outdent()
		message(CHECK_FAIL "not found.")
		list(APPEND CLS_EXAMPLE_MISSING_DEPENDENCIES ${DOWNLOAD_LIBRARY_NAME})
	else()
		outdent()
		message(CHECK_PASS "found.")
	endif()
...
macro(use_version)
	...
	LIST(APPEND CLS_EXAMPLE_CURRENT_OPTIONS CPM_${use_version_NAME}_VERSION)
	list(APPEND CLS_EXAMPLE_DEPENDENCIES "${DOWNLOAD_LIBRARY_NAME}[${CPM_${use_version_NAME}_VERSION}]")
endmacro()
