...
set(CLS_EXAMPLE_WARNING_GUARD "")
if(NOT PROJECT_IS_TOP_LEVEL)
  option(
      CLS_EXAMPLE_INCLUDES_WITH_SYSTEM
      "Use SYSTEM modifier for shared's includes, disabling warnings"
      ON
  )
  mark_as_advanced(CLS_EXAMPLE_INCLUDES_WITH_SYSTEM)
  if(CLS_EXAMPLE_INCLUDES_WITH_SYSTEM)
    set(CLS_EXAMPLE_WARNING_GUARD SYSTEM)
  endif()
endif()