/*****************************************************************//**
@file   version.hpp
@brief  Contains informations related to current version
...
namespace CLS_Example::version
{
    ...
    **/
    inline constexpr const char * full = "0.0.0+1.90c98b3";
